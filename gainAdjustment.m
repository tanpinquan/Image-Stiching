function imagesAdjust = gainAdjustment(images, H, matchGraph)
...
for i=1:length(matchingAdj)
    for j = i+1:length(matchingAdj)
        if(matchingAdj(i,j))
            ...
            %% Plot for image 1
%             figure;
%             subplot(1,2,1);plot(fixedPoly)
%             hold on;plot(mappedPoly)
%             
%             subplot(1,2,2);plot(fixedPoly)
%             hold on; plot(fixedOverlappedPoly);
            ...
            %% Plot for image 2
%             figure;
%             subplot(1,2,1);plot(mappedPoly2)
%             hold on;plot(movingPoly)
%             
%             subplot(1,2,2);plot(movingOverlappedPoly)
%             hold on; plot(movingPoly);
